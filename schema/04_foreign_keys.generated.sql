...
ALTER TABLE discounts.statutory_discount_policy_import_review_submissions ADD CONSTRAINT fk_sd_policy_import_review_submissions__submitted_by_user FOREIGN KEY (submitted_by_operator_user_id) REFERENCES identity.users(user_id) DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE discounts.statutory_discount_policy_import_review_submissions ADD CONSTRAINT fk_sd_policy_import_review_submissions__superseded_by FOREIGN KEY (superseded_by_review_submission_id) REFERENCES discounts.statutory_discount_policy_import_review_submissions(review_submission_id) DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE discounts.statutory_discount_policy_import_review_decisions ADD CONSTRAINT fk_sd_policy_import_review_decisions__submission_id FOREIGN KEY (review_submission_id) REFERENCES discounts.statutory_discount_policy_import_review_submissions(review_submission_id) DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE discounts.statutory_discount_policy_import_review_decisions ADD CONSTRAINT fk_sd_policy_import_review_decisions__reviewer_user FOREIGN KEY (reviewer_operator_user_id) REFERENCES identity.users(user_id) DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE discounts.statutory_discount_policy_import_review_findings ADD CONSTRAINT fk_sd_policy_import_review_findings__submission_id FOREIGN KEY (review_submission_id) REFERENCES discounts.statutory_discount_policy_import_review_submissions(review_submission_id) DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE discounts.statutory_discount_policy_import_review_history ADD CONSTRAINT fk_sd_policy_import_review_history__submission_id FOREIGN KEY (review_submission_id) REFERENCES discounts.statutory_discount_policy_import_review_submissions(review_submission_id) DEFERRABLE INITIALLY IMMEDIATE;

ALTER TABLE discounts.statutory_discount_policy_import_review_history ADD CONSTRAINT fk_sd_policy_import_review_history__actor_user FOREIGN KEY (actor_operator_user_id) REFERENCES identity.users(user_id) DEFERRABLE INITIALLY IMMEDIATE;
