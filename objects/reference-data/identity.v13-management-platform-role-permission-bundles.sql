...
('OPERATIONS_SUPERVISOR','fiscal-reporting.ej.read'),('OPERATIONS_SUPERVISOR','fiscal-reporting.ej.export'),
('OPERATIONS_SUPERVISOR','fiscal-reporting.x.read'),('OPERATIONS_SUPERVISOR','fiscal-reporting.x.generate'),
('OPERATIONS_SUPERVISOR','fiscal-reporting.z.read'),('OPERATIONS_SUPERVISOR','fiscal-reporting.z.generate'),
...
('SITE_OPERATOR','fiscal-reporting.ej.read'),('SITE_OPERATOR','fiscal-reporting.ej.export'),
('SITE_OPERATOR','fiscal-reporting.x.read'),('SITE_OPERATOR','fiscal-reporting.x.generate'),
