...
CREATE TABLE IF NOT EXISTS reconciliation.reconciliation_exception_notes (
    ...
    CONSTRAINT pk_recon_exception_notes PRIMARY KEY (reconciliation_exception_note_id),
    ...
    CONSTRAINT fk_recon_exception_notes__exception FOREIGN KEY (reconciliation_exception_id) REFERENCES reconciliation.reconciliation_exceptions(reconciliation_exception_id) DEFERRABLE,
    CONSTRAINT fk_recon_exception_notes__run FOREIGN KEY (reconciliation_run_id) REFERENCES reconciliation.reconciliation_runs(reconciliation_run_id) DEFERRABLE,
    CONSTRAINT fk_recon_exception_notes__item FOREIGN KEY (reconciliation_item_id) REFERENCES reconciliation.reconciliation_items(reconciliation_item_id) DEFERRABLE,
    CONSTRAINT fk_recon_exception_notes__audit_event FOREIGN KEY (audit_event_id) REFERENCES audit.audit_events(audit_event_id) DEFERRABLE,
    CONSTRAINT fk_recon_exception_notes__audit_trail FOREIGN KEY (audit_trail_entry_id) REFERENCES audit.audit_trail_entries(audit_trail_entry_id) DEFERRABLE,
    CONSTRAINT fk_recon_exception_notes__created_user FOREIGN KEY (created_by_user_id) REFERENCES identity.users(user_id) DEFERRABLE,
    CONSTRAINT fk_recon_exception_notes__created_service FOREIGN KEY (created_by_service_identity_id) REFERENCES identity.service_identities(service_identity_id) DEFERRABLE
);
...
CREATE TABLE IF NOT EXISTS reconciliation.reconciliation_exception_resolution_requests (
    ...
    row_version bigint DEFAULT 1 NOT NULL,
    CONSTRAINT pk_recon_exception_resolution_requests PRIMARY KEY (reconciliation_exception_resolution_request_id),
    CONSTRAINT ck_recon_ex_res_requests__row_version CHECK (row_version > 0),
    CONSTRAINT ck_recon_ex_res_requests__amount_delta CHECK (amount_delta IS NULL OR amount_delta >= 0),
    CONSTRAINT ck_recon_ex_res_requests__evidence_hash CHECK (evidence_hash IS NULL OR length(evidence_hash) = 64),
    CONSTRAINT ck_recon_ex_res_requests__submitted CHECK (
        request_status = 'DRAFT'
        OR submitted_at IS NOT NULL
    ),
    CONSTRAINT ck_recon_ex_res_requests__financial_flags CHECK (
    ...
    CONSTRAINT ck_recon_ex_res_requests__adjustment CHECK (
        adjustment_required_flag = false
        OR financial_impact IN ('POSSIBLE', 'DEFINITE')
    ),
    CONSTRAINT fk_recon_ex_res_requests__exception FOREIGN KEY (reconciliation_exception_id) REFERENCES reconciliation.reconciliation_exceptions(reconciliation_exception_id) DEFERRABLE,
    CONSTRAINT fk_recon_ex_res_requests__run FOREIGN KEY (reconciliation_run_id) REFERENCES reconciliation.reconciliation_runs(reconciliation_run_id) DEFERRABLE,
    CONSTRAINT fk_recon_ex_res_requests__item FOREIGN KEY (reconciliation_item_id) REFERENCES reconciliation.reconciliation_items(reconciliation_item_id) DEFERRABLE,
    CONSTRAINT fk_recon_ex_res_requests__maker_user FOREIGN KEY (maker_user_id) REFERENCES identity.users(user_id) DEFERRABLE,
    CONSTRAINT fk_recon_ex_res_requests__maker_service FOREIGN KEY (maker_service_identity_id) REFERENCES identity.service_identities(service_identity_id) DEFERRABLE,
    CONSTRAINT fk_recon_ex_res_requests__audit_event FOREIGN KEY (audit_event_id) REFERENCES audit.audit_events(audit_event_id) DEFERRABLE,
    CONSTRAINT fk_recon_ex_res_requests__audit_trail FOREIGN KEY (audit_trail_entry_id) REFERENCES audit.audit_trail_entries(audit_trail_entry_id) DEFERRABLE,
    CONSTRAINT fk_recon_ex_res_requests__created_user FOREIGN KEY (created_by_user_id) REFERENCES identity.users(user_id) DEFERRABLE,
    CONSTRAINT fk_recon_ex_res_requests__created_service FOREIGN KEY (created_by_service_identity_id) REFERENCES identity.service_identities(service_identity_id) DEFERRABLE,
    CONSTRAINT fk_recon_ex_res_requests__updated_user FOREIGN KEY (updated_by_user_id) REFERENCES identity.users(user_id) DEFERRABLE,
    CONSTRAINT fk_recon_ex_res_requests__updated_service FOREIGN KEY (updated_by_service_identity_id) REFERENCES identity.service_identities(service_identity_id) DEFERRABLE
);
...
CREATE TABLE IF NOT EXISTS reconciliation.reconciliation_exception_resolution_approvals (
    ...
    created_by_service_identity_id uuid,
    row_version bigint DEFAULT 1 NOT NULL,
    CONSTRAINT pk_recon_exception_resolution_approvals PRIMARY KEY (reconciliation_exception_resolution_approval_id),
    CONSTRAINT ck_recon_ex_res_approvals__row_version CHECK (row_version > 0),
    CONSTRAINT ck_recon_ex_res_approvals__decision_time CHECK (
    ...
    CONSTRAINT ck_recon_ex_res_approvals__reject_reason CHECK (
        approval_decision = 'APPROVED'
        OR rejection_reason_code IS NOT NULL
    ),
    CONSTRAINT ck_recon_ex_res_approvals__maker_checker_user CHECK (
        maker_user_id IS NULL
        OR checker_user_id IS NULL
        OR maker_user_id <> checker_user_id
    ),
    CONSTRAINT ck_recon_ex_res_approvals__maker_checker_service CHECK (
    ...
    CONSTRAINT fk_recon_ex_res_approvals__request FOREIGN KEY (reconciliation_exception_resolution_request_id) REFERENCES reconciliation.reconciliation_exception_resolution_requests(reconciliation_exception_resolution_request_id) DEFERRABLE,
    CONSTRAINT fk_recon_ex_res_approvals__exception FOREIGN KEY (reconciliation_exception_id) REFERENCES reconciliation.reconciliation_exceptions(reconciliation_exception_id) DEFERRABLE,
    CONSTRAINT fk_recon_ex_res_approvals__run FOREIGN KEY (reconciliation_run_id) REFERENCES reconciliation.reconciliation_runs(reconciliation_run_id) DEFERRABLE,
    CONSTRAINT fk_recon_ex_res_approvals__item FOREIGN KEY (reconciliation_item_id) REFERENCES reconciliation.reconciliation_items(reconciliation_item_id) DEFERRABLE,
    CONSTRAINT fk_recon_ex_res_approvals__checker_user FOREIGN KEY (checker_user_id) REFERENCES identity.users(user_id) DEFERRABLE,
    CONSTRAINT fk_recon_ex_res_approvals__checker_service FOREIGN KEY (checker_service_identity_id) REFERENCES identity.service_identities(service_identity_id) DEFERRABLE,
    CONSTRAINT fk_recon_ex_res_approvals__maker_user FOREIGN KEY (maker_user_id) REFERENCES identity.users(user_id) DEFERRABLE,
    CONSTRAINT fk_recon_ex_res_approvals__maker_service FOREIGN KEY (maker_service_identity_id) REFERENCES identity.service_identities(service_identity_id) DEFERRABLE,
    CONSTRAINT fk_recon_ex_res_approvals__audit_event FOREIGN KEY (audit_event_id) REFERENCES audit.audit_events(audit_event_id) DEFERRABLE,
    CONSTRAINT fk_recon_ex_res_approvals__audit_trail FOREIGN KEY (audit_trail_entry_id) REFERENCES audit.audit_trail_entries(audit_trail_entry_id) DEFERRABLE,
    CONSTRAINT fk_recon_ex_res_approvals__created_user FOREIGN KEY (created_by_user_id) REFERENCES identity.users(user_id) DEFERRABLE,
    CONSTRAINT fk_recon_ex_res_approvals__created_service FOREIGN KEY (created_by_service_identity_id) REFERENCES identity.service_identities(service_identity_id) DEFERRABLE
);
...
CREATE TABLE IF NOT EXISTS reconciliation.reconciliation_exception_status_history (
    ...
    created_by_service_identity_id uuid,
    row_version bigint DEFAULT 1 NOT NULL,
    CONSTRAINT pk_recon_exception_status_history PRIMARY KEY (reconciliation_exception_status_history_id),
    CONSTRAINT ck_recon_exception_status_history__row_version CHECK (row_version > 0),
    CONSTRAINT ck_recon_exception_status_history__status_changed CHECK (
        previous_exception_status IS NULL
        OR previous_exception_status <> new_exception_status
    ),
    CONSTRAINT fk_recon_exception_status_history__exception FOREIGN KEY (reconciliation_exception_id) REFERENCES reconciliation.reconciliation_exceptions(reconciliation_exception_id) DEFERRABLE,
    CONSTRAINT fk_recon_exception_status_history__run FOREIGN KEY (reconciliation_run_id) REFERENCES reconciliation.reconciliation_runs(reconciliation_run_id) DEFERRABLE,
    CONSTRAINT fk_recon_exception_status_history__item FOREIGN KEY (reconciliation_item_id) REFERENCES reconciliation.reconciliation_items(reconciliation_item_id) DEFERRABLE,
    CONSTRAINT fk_recon_exception_status_history__request FOREIGN KEY (reconciliation_exception_resolution_request_id) REFERENCES reconciliation.reconciliation_exception_resolution_requests(reconciliation_exception_resolution_request_id) DEFERRABLE,
    CONSTRAINT fk_recon_exception_status_history__approval FOREIGN KEY (reconciliation_exception_resolution_approval_id) REFERENCES reconciliation.reconciliation_exception_resolution_approvals(reconciliation_exception_resolution_approval_id) DEFERRABLE,
    CONSTRAINT fk_recon_exception_status_history__changed_user FOREIGN KEY (changed_by_user_id) REFERENCES identity.users(user_id) DEFERRABLE,
    CONSTRAINT fk_recon_exception_status_history__changed_service FOREIGN KEY (changed_by_service_identity_id) REFERENCES identity.service_identities(service_identity_id) DEFERRABLE,
    CONSTRAINT fk_recon_exception_status_history__audit_event FOREIGN KEY (audit_event_id) REFERENCES audit.audit_events(audit_event_id) DEFERRABLE,
    CONSTRAINT fk_recon_exception_status_history__audit_trail FOREIGN KEY (audit_trail_entry_id) REFERENCES audit.audit_trail_entries(audit_trail_entry_id) DEFERRABLE,
    CONSTRAINT fk_recon_exception_status_history__created_service FOREIGN KEY (created_by_service_identity_id) REFERENCES identity.service_identities(service_identity_id) DEFERRABLE
);
